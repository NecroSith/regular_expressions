...
// Must contain domain part (.ru, .com etc)

const urlExpr = /^(?!.*:\/\/{2,})(?=.*:\/\/)(?:http|https|ftp):\/\/[\w\.\/()\-?=&:@]{1,}\.[\w\.\/()\-?=&:@]{2,}$/g;
...
// Invalid urls
const invalidData = ["https:///yande.xru", "htpp://example.com", "google.com", "http//trainwreck.uk", "https://r.tu", "http://1.2", "https://23232323232323232323"];
